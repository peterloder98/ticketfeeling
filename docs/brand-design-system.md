...
| `BrandLogo` | Offizielles Lockup `/brand/logo-ticketfeeling.png` |
...
- Datei: `apps/web/public/brand/logo-ticketfeeling.png`
- Weitere Varianten (Icon, Favicon) folgen — bis dahin Lockup mit dunkler Plate auf hellen Flächen
