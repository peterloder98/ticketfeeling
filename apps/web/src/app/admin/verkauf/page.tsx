...
export const metadata = { title: "Verkauf" };

export default function VerkaufHubPage() {
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-1 text-3xl font-semibold tracking-tight text-[var(--tf-navy)]">Verkauf</h1>
        <p className="mt-2 text-[var(--tf-text-secondary)]">
          Kasse, Partner, Scanner und Rabatte.
        </p>
      </div>
      <AdminSubnav items={ADMIN_SUBNAV.verkauf} />
      <AdminHubCards items={adminHubItems("verkauf")} />
    </div>
  );
}
